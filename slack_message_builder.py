...
class SlackClientMessageBuilder:
    """This thing is what will actually construct and send off the birthday wishes."""

    BIRTHDAY_MESSAGE = {
        "text": "Teferi's Age Insight",
        "icon_emoji": ":teferi:",
        "attachments": [
            {
                "color": "#2e3b66",
                "ts": "",
                "title": "Teferi's Age Insight",
                "text": "",
                "footer": "Birthdays today"
            }
        ]
    }
    ...
    def __init__(self, channel):
        ...
        self.username = "teferi"
        self.icon_emoji = ":teferi:"
